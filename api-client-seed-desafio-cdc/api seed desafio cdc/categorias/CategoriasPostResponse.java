...
public class CategoriasPostResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String nome;
    /**
     * Instantiates a new {@link CategoriasPostResponse} and sets the default values.
     */
    public CategoriasPostResponse() {
    ...
    public static CategoriasPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CategoriasPostResponse();
    }
    /**
