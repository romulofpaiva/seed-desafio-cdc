...
public class EstadosPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String nome;
    /**
     * Instantiates a new {@link EstadosPostRequestBody} and sets the default values.
     */
    public EstadosPostRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link EstadosPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static EstadosPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new EstadosPostRequestBody();
    }
    /**
