...
public class PaisesPostResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String nome;
    /**
     * Instantiates a new {@link PaisesPostResponse} and sets the default values.
     */
    public PaisesPostResponse() {
    ...
    public static PaisesPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PaisesPostResponse();
    }
    /**
