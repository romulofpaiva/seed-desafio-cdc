...
public class Livro implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Livro} and sets the default values.
     */
    public Livro() {
    ...
    public static Livro createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
