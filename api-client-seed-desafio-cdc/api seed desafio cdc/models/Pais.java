...
public class Pais implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String nome;
    /**
     * Instantiates a new {@link Pais} and sets the default values.
     */
    public Pais() {
    ...
    public static Pais createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
