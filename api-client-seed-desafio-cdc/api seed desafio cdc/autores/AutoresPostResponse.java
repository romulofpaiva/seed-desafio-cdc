...
public class AutoresPostResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String nome;
    /**
     * Instantiates a new {@link AutoresPostResponse} and sets the default values.
     */
    public AutoresPostResponse() {
    ...
    public static AutoresPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AutoresPostResponse();
    }
    /**
