...
public class CuponsPostResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CuponsPostResponse} and sets the default values.
     */
    public CuponsPostResponse() {
    ...
    public static CuponsPostResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CuponsPostResponse();
    }
    /**
